        ...
        when (call.method) {
            ...
            "savePendingLogin" -> {
                ...
                if (packageName != null && username != null && password != null) {
                    val prefs = context.getSharedPreferences("com.keevault.flutter_autofill_service.pending", Context.MODE_PRIVATE)
                    prefs.edit().apply {
                    ...
                    result.error("INVALID_ARGUMENTS", "packageName, username, and password must not be null", null)
                }
            }
